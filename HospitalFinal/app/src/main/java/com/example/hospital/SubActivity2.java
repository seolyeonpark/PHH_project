...
public class SubActivity2 extends AppCompatActivity implements CompoundButton.OnCheckedChangeListener {
    ...
    public TextView heart_value;
    public TextView heart_value2;
    public TextView oxygen_value;
    public TextView oxygen_value2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textTemp = (TextView)findViewById(R.id.patient_tmp);//온도 값
        textTemp2 = (TextView)findViewById(R.id.patient_tmp2);

        heart_value = (TextView)findViewById(R.id.patient_heart);
        heart_value2 = (TextView)findViewById(R.id.patient_heart2);

        //oxygen_value = (TextView)findViewById(R.id.patient_oxygen);
        //oxygen_value2 = (TextView)findViewById(R.id.patient_oxygen2);
    ...
    public void MQTT_Create(boolean mtqqStart) {
        if (mtqqStart && mqttClient == null) {
            ...
            // added by J. Yun, SCH Univ.
            SubscribeResource subcribeResource = new SubscribeResource("P1", "temp");
            ...
            // added by J. Yun, SCH Univ.
            subcribeResource = new SubscribeResource("P2", "temp");
            subcribeResource.setReceiver(new IReceived() {
                public void getResponseBody(final String msg) {
                    handler.post(new Runnable() {
                        public void run() {
            ...
            subcribeResource = new SubscribeResource("P1", "max30102");
            subcribeResource.setReceiver(new IReceived() {
                public void getResponseBody(final String msg) {
                    handler.post(new Runnable() {
                        public void run() {
            ...
            // added by J. Yun, SCH Univ.
            subcribeResource = new SubscribeResource("P2", "max30102");
            subcribeResource.setReceiver(new IReceived() {
                public void getResponseBody(final String msg) {
                    handler.post(new Runnable() {
                        public void run() {
            ...
            /* MQTT Subscribe */
            mqttClient = new MqttAndroidClient(this.getApplicationContext(), "tcp://" + csebase.getHost() + ":" + csebase.getMQTTPort(), MqttClient.generateClientId());//not guilty
...
//            textViewData.setText(con);
            ...
            if (cnt.indexOf("temp") != -1) {
                textTemp.setText(getContainerContentJSON(message.toString()));
                textTemp2.setText(getContainerContentJSON(message.toString()));
            }
            //else if (cnt.indexOf("temp2") != -1)
                //textTemp.setText(getContainerContentJSON(message.toString()));
            else if (cnt.indexOf("max30102") != -1) {
                heart_value.setText(getContainerContentJSON(message.toString()));
                heart_value2.setText(getContainerContentJSON(message.toString()));
            }
            else
                ;
...
//            Log.d(TAG, "Content is " + con);
    ...
    public void OnClickHandler(View view) {//버튼 누르면 가져옴
        RetrieveRequest req = new RetrieveRequest("P1","temp");
        ...
        req = new RetrieveRequest("P2","temp");
        req.setReceiver(new IReceived() {
            public void getResponseBody(final String msg) {
                handler.post(new Runnable() {
                    public void run() {
                        textTemp2.setText(getContainerContentXML(msg));
                    }
                });
            }
        });
        ...
        req = new RetrieveRequest("P1","max30102");
        req.setReceiver(new IReceived() {
            public void getResponseBody(final String msg) {
                handler.post(new Runnable() {
                    public void run() {
                        heart_value.setText(getContainerContentXML(msg));
                    }
                });
            }
        });
        ...
        req = new RetrieveRequest("P2","max30102");
        req.setReceiver(new IReceived() {
            public void getResponseBody(final String msg) {
                handler.post(new Runnable() {
                    public void run() {
                        heart_value2.setText(getContainerContentXML(msg));
                    }
                });
            }
        });
    ...
    class RetrieveRequest extends Thread {
        ...
        public RetrieveRequest(String containerName,String containerName2) {
        ...
        public void run() {
            try {
                String sb = csebase.getServiceUrl() + "/" + ServiceAEName + "/" + ContainerName + "/" + ContainerName2 + "/" + "latest";
    ...
    class SubscribeResource extends Thread {
        ...
        public SubscribeResource(String containerName, String container_name2) {
            ...
            this. container_name2 = container_name2;
        }
        ...
        public void run() {
            try {
                ...
                String sb = csebase.getServiceUrl() + "/" + ServiceAEName + "/" + container_name + "/" + container_name2;
