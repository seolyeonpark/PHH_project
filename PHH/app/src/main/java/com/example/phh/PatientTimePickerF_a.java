...
public class PatientTimePickerF_a extends DialogFragment implements TimePickerDialog.OnTimeSetListener {
    ...
    public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
        ...
        Intent intent = new Intent(getContext(), PatientAlertReceiver_a.class);//동작안함
        PendingIntent operation = PendingIntent.getBroadcast(getContext(), 1, intent, 0);
    ...
    public void updateTimeText(Calendar c) {
        ...
        TextView mTextView = getActivity().findViewById(R.id.morningtime);
