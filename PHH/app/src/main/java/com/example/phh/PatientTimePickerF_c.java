...
public class PatientTimePickerF_c extends DialogFragment implements TimePickerDialog.OnTimeSetListener {
    ...
    public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
        ...
        Intent intent = new Intent(getContext(), PatientAlertReceiver_c.class);//동작안함
